...
```
Monte Carlo prop-firm evaluation solver.
```

## How GOROSHI uses it

`Sizing + scenario analysis for FTMO challenges.`
...
`None.` -- e.g. "called from `goroshi-swarm/bin/worker.py`
